...
export class SupplierInteractionService {
  ...
  getSupplier() {
    this.http.get<{message: string, suppliers: any}>('api/supplier')
  ...
  addSupplier( supplierID: string, name: string, email: string, contact: string, drugsAvailable: string) {
    ...
    this.http.post<{message: string, supplierId: string}>('api/supplier',supplier)
  ...
  deleteSupplier(supplierId: string) {
    this.http.delete('api/supplier/' + supplierId)
      .subscribe(() => {
