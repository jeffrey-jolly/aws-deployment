...
export class AuthDoctorUserService {
  ...
  createDoctorUser(name: string , contact: string , docId: string ,email: string ,password: string ){
    ...
    this.http.post("api/doctorUser/doctorSignup",authDoctorData)
      .subscribe(response =>{
  ...
  login(email: string, password){
    ...
    this.http.post<{token: string, expiresIn: number, name:string, contact: string, email:string,docId:string}>("api/doctorUser/doctorLogin",authDoctorData)
      .subscribe(response =>{
    ...
    ('api/doctorUser/shoppingcart/'+email);
  ...
  //   return this.http.get<{userId:string,role:string}>("api/user/profile/"+id);
  //  }
  ...
  getDoctorData() {
    this.http.get<{message: string, doctors: any}>('api/doctorUser/getDoctorUserData')
    .pipe(map(docData => {
  ...
  deleteUser(userId: string) {
    this.http.delete('api/doctorUser/' +userId)
      .subscribe(() => {
...
//   getAll() {
//     return this.http.get<AuthDoctorData[]>('api/doctorUser');
// }
